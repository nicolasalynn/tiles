...
def tiles_pipeline(input_path: Path, job_id: str | None = None) -> Tuple[bool, List[str], List[Dict[str, Any]], Dict[str, Any]]:
    ...
    process_with_dask_pipeline(
        ...
        cluster_config={"memory_size": "6GB", "queue": "tamirQ", "num_workers": 5},
    ...
    meta = {
        ...
        "splice_disrupting_mutations": splice_disrupting,
        "tss_disrupting_mutations": tss_disrupting,
        # TODO: replace placeholders below when those modules are wired in
